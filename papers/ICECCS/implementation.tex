...
While the first two strategies were described previously in literature~\cite{CMOP:08:FFMTRTUR}, the last two are new as nobody thought of modifying the probabilities over time.
