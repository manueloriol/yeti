...
public class YetiLauncher extends JFrame {
        ...
        private String[] timeArray = {"5", "10", "15", "20", "30", "40",
"50",
...
"1000"
        ...
        public YetiLauncher () {
                ...
                GridBagConstraints c = new GridBagConstraints(); // for
object position.
               ...
               headingLabel = new JLabel("York Extensible Testing
Infrastructure");
                ...
                selectFiles = new JButton("Browse");
                c.gridx = 2;
                c.gridy = 6;
                c.insets = new Insets(15,15,15,15);
                add(selectFiles, c);
                browseBHandler = new BrowseButtonHandler();
                selectFiles.addActionListener(browseBHandler);
                ...
                pack(); // pack method collect the scattered objects on
gui to one point.
        ...
        public static void main(String[] args){
                ...
                private class BrowseButtonHandler extends JFrame implements
ActionListener {
                        public void actionPerformed(ActionEvent e) {
